                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <asp:Label runat="server" class="checkbox-inline">
                                ...
                                <span>The King's School IT Policy document can be found <a href="http://vle.kings-school.co.uk/pupil-guides-policies-and-rules" target="_blank">here</a></span><br />
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-3 col-md-9">
                            <asp:Button runat="server" Text="Register Device" CssClass="btn btn-default" OnClick="RegisterDevice_Click" />
                        </div>
                    </div>
                </div>
            </section>
